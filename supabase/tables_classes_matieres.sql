-- Tables pour classes, matières et relations

-- Table classes
CREATE TABLE IF NOT EXISTS classes (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL UNIQUE, -- Ex: "Secondaire 1", "Secondaire 2", "Secondaire 3"
...
CREATE TABLE IF NOT EXISTS matieres (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL UNIQUE, -- Ex: "Mathématiques", "Physique", "Histoire"
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- Ajouter email et prenom à la table users
